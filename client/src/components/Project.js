...
function ProjectCards(props) {
    return (
        ...
        <div className={`grid-item gallery__item--${props.id}`}>
            ...
            <div className="desc">  <h5>{props.name}</h5>  </div>


            <div className='dep-links'>
                <a href={props.github} target="_blank"><img src="https://img.icons8.com/color/48/000000/github--v1.png" alt="Github Repository" id="github-icon"/></a>
